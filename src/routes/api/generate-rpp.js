...
4.6, 3.10 4.10, 3.11, 4.11, 3.12 4.12.'`;
    ...
    prompt += `Isi key 'kegiatan' dengan kegiatan pembelajaran yang sesuai dengan model pembelajaran yang dipilih. Terdapat juga waktu untuk setiap kegiatan, contoh: '**Kegiatan Pendahuluan (10 menit)**:\n\tGuru menyapa siswa dan memperkenalkan tema pembelajaran hari ini yaitu...'. Pastikan untuk menuliskan waktu untuk setiap kegiatan, dan gunakan format yang konsisten seperti contoh di atas bisa juga sebagai list item.`;
